...
void _fm_mime_type_init() {
    mime_hash = g_hash_table_new_full(g_str_hash, g_str_equal, NULL, fm_mime_type_unref);
 ...
 * Since: 0.1.0
 */
FmMimeType* fm_mime_type_from_native_file(const char* file_path, const char* base_name, struct stat* pstat) {
    FmMimeType* mime_type;
    struct stat st;
